                ...
                <nav class="cyan">
                    <div class="nav-wrapper">
                        ...
                        <div class="header-search-wrapper hide-on-med-and-down">
                            ...
                            <input type="text" name="Search" class="header-search-input z-depth-2" placeholder="Explore TAPS--feature coming soon"/>
                        </div>
            ...
            <div class="wrapper">
                <aside id="left-sidebar-nav">
                    <ul id="slide-out" class="side-nav fixed leftside-navigation">
                        ...
                        <li class="bold "><a href="<?php echo base_url('/admin/featured')?>" class="waves-effect waves-cyan"><i class="mdi-action-dashboard"></i> Dashboard/All Boats</a>
                        </li>
                         <li class="bold "><a href="<?php echo base_url('/admin/allcountry')?>" class="waves-effect waves-cyan"><i class="mdi-action-dashboard"></i> Countries of Operation</a>
                        </li>
                         <li class="bold "><a href="<?php echo base_url('/admin/addcountry')?>" class="waves-effect waves-cyan"><i class="mdi-action-dashboard"></i> Add Country</a>
                        </li>
